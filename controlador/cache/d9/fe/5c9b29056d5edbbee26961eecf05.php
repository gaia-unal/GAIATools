...
/* puenteEnsenaloResponseCorrect.twig.html */
class __TwigTemplate_d9fe5c9b29056d5edbbee26961eecf05 extends Twig_Template
{
    protected $parent;
...
<div class=\"presentacion\">
    <header><h2><font color=\"#0489B1\" size=\"5\">";
        ...
        echo ", usted creará una actividad de respuesta correcta para evaluar ";
        echo twig_escape_filter($this->env, $this->getContext($context, 'titulo'), "html");
    ...
    <div id=\"tipopreg\">
        ...
        <button id=\"actividad\" class=\"selecPreg btn-default\" onclick=\"guardarTemp('ensenaloResponseCorrect.php');\">Continuar<br><br><img id=\"retornar\" src=\"../images/18.png\" width=\"20\" heigth=\"20\" align=\"center\"></button>
...
";
    ...
    {
        return "puenteEnsenaloResponseCorrect.twig.html";
    }
